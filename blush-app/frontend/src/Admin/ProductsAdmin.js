            ...
            {/* sidebarend */}
                ...
                <div className="flex items-center justify-between gap-6 p-4 border border-color12 rounded">
                   {/* img product */}
                    ...
                    <Link to=""  className="px-2 py-2 bg-color10 border border-color10 text-color11 font-medium rounded flex items-center gap-2 hover:bg-transparent hover:text-color10 transition"> Edit</Link>
