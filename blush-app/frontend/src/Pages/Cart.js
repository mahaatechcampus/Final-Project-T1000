              ...
              <div className="flex items-center hover:bg-color8 -mx-8 px-6 py-5">
                ...
                <div className="flex w-2/5"> 
                  ...
                  <div className="flex flex-col justify-between ml-4 flex-grow">
                    ...
                    <Link to="#" onClick={() => deleteProductcart(product)} className="flex font-medium hover:text-color10  text-color14 text-xs">  <svg xmlns="http://www.w3.org/2000/svg" className="  h-4 w-4 fill-current mr-2 " viewBox="0 0 20 20" fill="currentColor">
