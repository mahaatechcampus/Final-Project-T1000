...
export default function ProductsList() {
    ...
    return (
        <>
        {/* shop wrapper */}
        <div className="container grid grid-cols-4 gap-6  pt-20 pb-16 items-start">
            {/* sidebar */}
            ...
            <div className="col-span-3">
                ...
                <select className="w-44 text-sm text-color4 px-4 py-3  border-color12 shadow-sm rounded focus:ring-color1 focus:border-color1">
