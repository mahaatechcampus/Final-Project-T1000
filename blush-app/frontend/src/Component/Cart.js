          ...
          <div className="flex shadow-md my-10">
            <div className="w-3/4 bg-color11 px-10 py-10">
              <div className="flex justify-between  border-b border-color12 pb-8">
                ...
                <h2 className="font-medium text-color5 text-2xl">3 Items</h2>
              </div>
              ...
              <div className="flex items-center hover:bg-color8 -mx-8 px-6 py-5">
                 <div className="flex w-2/5"> {/*<!-- product --> */}
                  ...
                  <div className="flex flex-col justify-between ml-4 flex-grow">
                    <span className="font-bold text-color3 text-sm">Iphone 6S</span>
                    <span className="text-color1 text-xs">Apple</span>
                    <Link to="#" className="font-medium hover:text-color10  text-color14 text-xs">Remove</Link>
                  </div>
                </div>
                <div className="flex justify-center w-1/5">
                  <svg className="fill-current text-color14 w-3" viewBox="0 0 448 512"><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
                  </svg>
      
                  <input className="mx-2 text-color3 border  border-color12 text-center w-8" type="text" value="1"/>
      
                  <svg className="fill-current text-color14 w-3" viewBox="0 0 448 512">
                    <path d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
                  </svg>
                </div>
                <span className="text-center text-color3 w-1/5 font-medium text-sm">400.00 SAR</span>
                <span className="text-center text-color3 w-1/5 font-medium text-sm">400.00 SAR</span>
              </div>
            ...
            <div id="summary" className="w-1/4 px-8 py-10">
              ...
              <div className="flex justify-between mt-10 mb-5">
                <span className="font-semibold text-color3 text-sm uppercase">Items 1</span>
                <span className="font-semibold  text-color1 text-sm">590 SAR</span>
              </div>
              <div className="flex justify-between mt-10 mb-5">
              ...
              <button className="bg-color1 text-color11  rounded-md hover:bg-transparent hover:text-color1 transition px-5 py-2 text-sm  uppercase">Apply</button>
              <div className="border-t border-color12 mt-8">
                <div className="flex font-semibold justify-between py-6 text-sm uppercase">
                  <span className="text-color3">Total cost</span>
                  <span className="text-color10">$600</span>
                </div>
                <button className="bg-color10  rounded-md font-semibold hover:bg-transparent hover:text-color10 transition py-3 text-sm text-color11 uppercase w-full">Checkout</button>
              </div>
            </div>
